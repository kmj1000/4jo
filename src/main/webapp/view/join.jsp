    ...
    <head>
       ...
       <link href="${pageContext.servletContext.contextPath}/bootstrap/css/styles.css" rel="stylesheet" />
        ...
        function verifyField(){
            ...
            let checkObj = document.getElementById("passwordConfirm");
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="${pageContext.servletContext.contextPath } /join" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                 <input class="form-control" name="nickname" id="nickname" type="text" placeholder="Enter your nickname" />
                                                <label for="nickname">NickName</label>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="phone" id="phone" type="number" placeholder="01012341234" />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="pwd-double-check" type="password" placeholder="Confirm password" onkeyup="doubleCheck(this.value);" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><a class="btn btn-primary btn-block" onclick="return verifyField()" >가입 완료</a></div>
                                            </div>
                                        </form>
                                    </div>
