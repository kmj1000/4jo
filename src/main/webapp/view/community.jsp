           ...
           <nav class="main1 sb-topnav2 navbar navbar-expand; navbar-dark bg-yellow" >
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-0 my-md-0 mt-sm-0 ">
                <div class="input-group">
                	<button type="button" class="btn" href="${pageContext.servletContext.contextPath}/main" style="font-size: 14px;">로그아웃</button>					
					<button type="button" class="btn" onclick="location.href'mypage.jsp'" style="font-size: 14px;">마이페이지</button>
                </div>
            </form>     
            </nav>
			...
			<main>
                    <div class="container-fluid px-3 pt-3">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="rightbtn">
                             	<a class="btn btn-warning" type="button" href="${pageContext.servletContext.contextPath}/api/communitycontent">글쓰기</a>
                             </div>
